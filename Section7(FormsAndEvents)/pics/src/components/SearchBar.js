...
class SearchBar extends React.Component {
    ...
    onFormSubmit = (event) => {
        ...
        // We are passing to the function that was passed as a prop in App.js (onSubmit={this.onSearchSubmit})
        // the term in the state for this component, so ultimately onSearchSubmit, with the term passed
        // into the search bar is what is called
